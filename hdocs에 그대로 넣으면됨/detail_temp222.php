	...
	<tbody>
			...
			<td rowspan="5" style="height:800px; border:1px solid #cccccc;">
				<div style="position:relative;">
					...
					<div class="draw-utility" style="position:absolute; top:100px; left:20px;">
						<span onclick="getEraser();" style="cursor:pointer;">ERASER</span>
					</div>

					<div class="draw-utility" style="position:absolute; top:130px; left:20px;">
						<span onclick="getClear();" style="cursor:pointer;">CLEAR</span>
					</div>

					<div id="play-button" style="display:none; position:absolute; top:20px; right:20px;">
						<input type="button" value="PLAY" onclick="playGame(3);" />
					</div>
				</div>
			</td>
		...
		<tr>
			<td style="height:30px; border:1px solid #cccccc; vertical-align:top;">
                <div id="chatInput">
                    메시지를 입력하세요 <input type='text' id='txtChat' name="txtChat"  style="width:100%; height:30px; line-height:30px; border-width:0px;">

                    <script language="JavaScript">
                        var su=prompt("insert number:");
                        alert(su);
                        document.write(su);
                    </script>
                </div>
